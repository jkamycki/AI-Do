...
function isMissingPalette(palette: PaletteShape | null | undefined): boolean {
...
export interface CustomDesignInput {
  customization: {
    ...
    colorPalette?: PaletteShape | null;
...
export function evaluateCustomDesignCompleteness(input: CustomDesignInput): CustomDesignCompleteness {
