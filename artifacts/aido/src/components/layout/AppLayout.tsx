...
export function AppLayout({ children, fullWidth = false }: AppLayoutProps) {
  ...
  return (
    <div className="portal-shell relative flex min-h-screen overflow-hidden bg-background">
      <div className="pointer-events-none fixed inset-0 z-0 bg-[url('/images/floral-bg.png')] bg-cover bg-center opacity-[0.1] mix-blend-multiply dark:opacity-[0.18] dark:mix-blend-luminosity" />
      <div className="pointer-events-none fixed inset-0 z-0 bg-[radial-gradient(circle_at_48%_0%,rgba(255,247,242,0.68)_0%,rgba(250,238,222,0.48)_38%,rgba(244,226,205,0.34)_100%)] dark:bg-[radial-gradient(circle_at_48%_0%,rgba(247,231,214,0.1)_0%,rgba(38,42,50,0.36)_40%,rgba(15,17,21,0.68)_100%)]" />
      {!isVendorWorkspace && (
        <SilentErrorBoundary>
          <Sidebar />
        </SilentErrorBoundary>
