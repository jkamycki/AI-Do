...
export const WEBSITE_THEMES: WebsiteTheme[] = [
  { id: "classic",   name: "A.IDO Rose",        font: "Playfair Display",     primary: "#8D294D", secondary: "#D88AA8", accent: "#E6B1A6", neutral: "#F7E7D6", background: "#FFF7F2", text: "#3A1826" },
  ...
  { id: "luxe",      name: "Luxe Burgundy",     font: "Playfair Display",     primary: "#5B0F2A", secondary: "#7A4A6A", accent: "#E6B1A6", neutral: "#1A0B14", background: "#FFF7F2", text: "#2B111D" },
