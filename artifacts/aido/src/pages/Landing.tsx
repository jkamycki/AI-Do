...
const features = [
  ...
  { icon: FileText, title: "Contract Analyzer", desc: "AI reviews your vendor contracts and flags risks before you sign." },
  ...
  { icon: Bot, title: "AI Assistant + Day-Of", desc: "Your AI planning companion — and emergency support when your wedding day arrives." },
];
