...
export default function InvitationCustomizationPage({ profileId: propProfileId }: InvitationCustomizationProps = {}) {
  ...
  useEffect(() => {
    ...
    autoSave();
  }, [saveTheDatePhotoFile, digitalInvitationPhotoFile, profileId, authedFetch, uploadPhotoMutation, primaryColor, autoGeneratedPalette, customColors, selectedPalette, backgroundColor, selectedFont, selectedLayout, backgroundImageUrl]);
  ...
  }, [profileId, primaryColor, autoGeneratedPalette, customColors, selectedPalette, backgroundColor, saveTheDatePhotoUrl, digitalInvitationPhotoUrl, selectedFont, selectedLayout, backgroundImageUrl, authedFetch]);
