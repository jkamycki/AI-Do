...
export default function InvitationCustomizationPage({ profileId: propProfileId }: InvitationCustomizationProps = {}) {
  ...
  useEffect(() => {
    ...
    saveTheDatePhotoUrl, saveTheDatePhotoPosition, saveTheDateFont, saveTheDateLayout, saveTheDateBackground, stdTextOverrides,
    digitalInvitationPhotoUrl, digitalInvitationPhotoPosition, digitalInvitationFont, digitalInvitationLayout, digitalInvitationBackground, digTextOverrides,
