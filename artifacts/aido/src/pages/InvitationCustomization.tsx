...
export default function InvitationCustomizationPage({ profileId: propProfileId }: InvitationCustomizationProps = {}) {
  ...
  useEffect(() => {
    ...
    autoSave();
  }, [saveTheDatePhotoFile, digitalInvitationPhotoFile, profileId, authedFetch, uploadPhotoMutation, primaryColor, autoGeneratedPalette, customColors, selectedPalette, backgroundColor, saveTheDateFont, digitalInvitationFont, selectedLayout, backgroundImageUrl]);
