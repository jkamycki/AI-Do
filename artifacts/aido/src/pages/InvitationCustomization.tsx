    ...
    <div className="max-w-7xl mx-auto p-3 sm:p-4 space-y-4 sm:space-y-6">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 sm:gap-6">
        ...
        <div className="lg:col-span-1 space-y-4 lg:max-h-[90vh] lg:overflow-y-auto">
          ...
          {/* Theme — same presets as the website editor so the Save the Date,
              RSVP invitation, and the wedding website can share a look. */}
          <Card>
            <CardContent className="p-4 space-y-3">
              <p className="text-sm font-medium flex items-center gap-2">
                <span className="text-base">🎨</span> Theme
              </p>
              <p className="text-xs text-muted-foreground">
                Pick a palette for both the Save the Date and the RSVP invitation.
              </p>
                  ...
                  return (
                    <button
                      ...
                      onClick={() => {
                        ...
                        setAutoGeneratedPalette(palette);
