...
export default function InvitationCustomizationPage({ profileId: propProfileId }: InvitationCustomizationProps = {}) {
  ...
  }, [profileId, primaryColor, autoGeneratedPalette, customColors, selectedPalette, backgroundColor, saveTheDatePhotoUrl, digitalInvitationPhotoUrl, saveTheDateFont, digitalInvitationFont, selectedLayout, backgroundImageUrl, authedFetch]);
