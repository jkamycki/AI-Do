...
export default function InvitationCustomizationPage({
  ...
  // Track preview container width to scale RsvpPagePreview on narrow screens
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 sm:gap-6">
        ...
        <div className="lg:col-span-1 space-y-4 lg:max-h-[90vh] lg:overflow-y-auto">
          ...
          <PhotoUploadSection
            ...
            saveTheDatePhotoPosition={
              useGeneratedInvitation ? saveTheDatePhotoPosition : undefined
            }
            onSaveTheDatePositionChange={
              useGeneratedInvitation ? setSaveTheDatePhotoPosition : undefined
            }
            digitalInvitationPhotoPosition={
              useGeneratedInvitation
                ? digitalInvitationPhotoPosition
            ...
            <div className="border-b p-3 sm:p-4 space-y-3">
              ...
              >
                <TabsList className="grid w-full grid-cols-3">
                  ...
                  <TabsTrigger value="rsvpPage" className="text-xs sm:text-sm px-1 sm:px-3">RSVP Page</TabsTrigger>
                </TabsList>
              </Tabs>
            </div>
              ...
              {isSTD ? (
                ...
                <div className="flex flex-col items-center gap-4">
                  ...
                  <p className="text-xs text-muted-foreground text-center max-w-xs">
                    This is exactly what your guests will see when they open
                    their RSVP link.
                  </p>
                </div>
              ) : useGeneratedInvitation ? (
