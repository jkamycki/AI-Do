...
export const GetProfileResponse = zod.object({
  ...
  "venueCountry": zod.string().nullish(),
  "venueStatus": zod.enum(['booked', 'not_yet', 'deciding']).optional(),
  "venueDiscovery": zod.record(zod.string(), zod.unknown()).nullish(),
  "venueBrainstorm": zod.record(zod.string(), zod.unknown()).nullish(),
  "planningPriorities": zod.object({
  "mustHaves": zod.array(zod.string()).optional(),
  "niceToHaves": zod.array(zod.string()).optional(),
  "mustAvoids": zod.array(zod.string()).optional()
}).nullish(),
...
export const GenerateTimelineBody = zod.object({
  ...
  "dayVision": zod.string().optional().describe('Free-form description of what the couple wants the day to feel like')
})
...
export const GetBudgetResponse = zod.object({
  ...
  "nextPaymentDue": zod.string().nullish().describe('ISO date string (YYYY-MM-DD) for next payment due date')
})),
  "updatedAt": zod.string()
})
...
export const GetBudgetItemPaymentsResponse = zod.array(GetBudgetItemPaymentsResponseItem)
...
export const GenerateChecklistBody = zod.object({
  ...
  "weddingVibe": zod.string(),
  "guestCount": zod.number(),
  "planningFocus": zod.string().optional().describe('Free-form checklist focus, priorities, or constraints from the couple')
})
...
export const GetGuestsResponse = zod.object({
  ...
  "needsHotel": zod.boolean().nullish(),
  "bookedHotelBlockId": zod.number().nullish(),
  "bookedHotelRoomCount": zod.number().nullish(),
  "notes": zod.string().nullish(),
  "rsvpMessage": zod.string().nullish(),
...
export const AddGuestBody = zod.object({
  ...
  "needsHotel": zod.boolean().optional(),
  "bookedHotelBlockId": zod.number().nullish(),
  "bookedHotelRoomCount": zod.number().nullish(),
  "notes": zod.string().optional()
})
...
export const ListManualExpensesResponse = zod.array(ListManualExpensesResponseItem)
