...
export const vendors = pgTable("vendors", {
  ...
  nextPaymentDue: text("next_payment_due"),
  files: jsonb("files").$type<Array<{ name: string; url: string; type: string; uploadedAt?: string; contractId?: number; contractFileName?: string }>>().default([]).notNull(),
...
export const vendorPartnerApplications = pgTable("vendor_partner_applications", {
  ...
  businessLogo: jsonb("business_logo").$type<{ name: string; type: string; dataUrl: string } | null>(),
  servicePhotos: jsonb("service_photos").$type<Array<{ name: string; type: string; dataUrl: string }>>().default([]).notNull(),
  directoryListing: jsonb("directory_listing").$type<Record<string, unknown>>().default({}).notNull(),
  directoryStatus: text("directory_status").notNull().default("not_created"),
  directoryPublishedAt: timestamp("directory_published_at"),
...
export const guests = pgTable("guests", {
  ...
  bookedHotelRoomCount: integer("booked_hotel_room_count"),
  notes: text("notes"),
...
export const invitationCustomizations = pgTable("invitation_customizations", {
  ...
  saveTheDateAccentColor: text("save_the_date_accent_color"),
  digitalInvitationAccentColor: text("digital_invitation_accent_color"),
